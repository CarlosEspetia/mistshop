...
@section('contenido')
    ...
    {!!Form::open(array('url'=>'ventas/venta','method'=>'POST','autocomplite'=>'off'))!!}
    {{Form::token()}}
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="num_comprobante" class="form-control" placeholder="Número comprobante..." required value="{{old('num_comprobante')}}">
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="panel panel-success" style="margin-top:25px; margin-left:15px; margin-right:15px">
            ...
            <div class="panel-heading">Ingreso Articulo</div>
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <div class="form-group">
                        <label for="btn_add">Opciones</label>
                        <button type="button" id="btn_add" class="btn btn-success btn-block" name="btn_add"><span class="fa fa-plus"></span> Agregar</button>   
                    </div>
                </div>
                ...
                if(idarticulo != '' && cantidad != '' && cantidad > 0 && descuento != '' && precio_venta != '' )
                {
                    ...
                    if(parseInt(stock) >= parseInt(cantidad))
                    {
                        ...
                        var fila = '<tr class="selected" id="fila'+cont+'">'+
                            '<td><button class="btn btn-danger" onclick="eliminar('+cont+')">x</button></td>'+
                    ...
                    {
                        alert('La cantidad de venta supera el stock.')
                    }
