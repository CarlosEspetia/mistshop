 ...
 *
 * @package  Controllers
 * @author   Carlos Espetia <devcarlosespetia@gmial.com>
 */
...
use mistshop\Articulo;

use Illuminate\Support\Facades\Redirect;

use Illuminate\Support\Facades\Input;

use mistshop\HTTP\Requests\ArticuloFormRequest;
...
class ArticuloController extends Controller
{
    ...
    public function store(ArticuloFormRequest $request)
    {
        ...
        $articulo->nombre = ucfirst($request->get('nombre'));
        ...
        if(Input::hasFile('imagen'))
        {
            ...
            $filename = $request->get('nombre').'.'.$file->getClientOriginalExtension();
